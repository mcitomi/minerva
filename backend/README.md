...
| GET | `/user/reactivate?code=VERIFYCODE&redirect=TARGET_SITE` | None | None | Az emailben kapott linkkel újra aktiválhatja a fiókját. A link tartalmazza a fiók egyedi megerősítőkódját, és a cél oldal linkjét.
| GET | `/user/pfp?u=USERID` | None | None | Lekérhetjük az adott felhasználó profilképét.
## Szerver:
