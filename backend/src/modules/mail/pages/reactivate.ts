export default (username: string, url: string) => {
    return `
    <!DOCTYPE html>
    <html lang="hu">
    <head>
    ...
    <body>
        <div class="container">
            <h1>Fiók aktiválás</h1>
            <h3>Kedves ${username}!</h3>
            <p>A fiókja aktiválásához kattintson az alábbi gombra:</p>
            <a href="${url}" class="button">Megerősítés</a>
            <p>A rendszer ezután elnavigálja önt a bejelentkező felületünkre.</p>
